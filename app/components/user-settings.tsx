...
import { Settings, X, Check, Plus, Sun, Moon, User, LogOut, Palette } from "lucide-react"
...
export default function UserSettings({ onThemeChangeAction, currentTheme, onLogoutAction }: UserSettingsProps) {
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              {/* Tab Navigation */}
              <div className="flex mb-6 p-1 rounded-lg flex-shrink-0"
                style={{
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                        activeTab === tab.id 
                          ? "text-white" 
