...
const AutoFillInstructions = lazy(() => import('../../pdf-components/dashboard/AutoFillInstructions'));
const PDFUploader = lazy(() => import('../../pdf-components/PDFUploader').then(module => ({ default: module.PDFUploader })));
const SimplePDFViewer = lazy(() => import('../../pdf-components/SimplePDFViewer').then(module => ({ default: module.SimplePDFViewer })));
const DownloadPopup = lazy(() => import('../../pdf-components/DownloadPopup').then(module => ({ default: module.DownloadPopup })));
const SupabaseFileDropdown = lazy(() => import('../../pdf-components/dashboard/SupabaseFileDropdown'));
...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 xl:grid-cols-2 gap-8 h-[calc(100vh-80px)]">
        {/* Left: Upload & Preview */}
        ...
        <div className="h-full flex flex-col gap-4">
          ...
          <div className="flex-1 min-h-0">
            <Suspense fallback={<div className="h-full bg-white/50 dark:bg-slate-800/50 backdrop-blur-lg rounded-xl animate-pulse" />}>
